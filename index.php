		...
		<div class="hero-header-11-content">
			<div class="container">
				<nav class="navbar navbar-expand-lg navbar-light py-md-2 py-0 px-0">
					<a class="navbar-brand" href="index.php"><img src="assets/images/logo-icon.png" alt="" /><b>Skill</b> <label>Devlopment</label></a>
         ...
         <div class="banner-item">
           <div class="banner-view">
             <div class="banner-info">
               ...
               <a href="#signup.php" class="btn btn-primary theme-button mr-3">Become a skill Devloper</a>
  ...
  <div class="new-block py-5">
    <div class="container py-lg-3">
      <div class="header-section text-center">
        <h3>How we Teach?</h3>
        <p class="mt-3 mb-5">Teaching in skill development involves practical application merged with theoretical understanding, fostering engagement and mastery through hands-on practice and active learning methodologies. Tailoring content to individual learning styles while emphasizing real-world application ensures comprehension and retention of skills</p>
        <a href="#signup.php" class="btn btn-primary theme-button">Join our Community</a>
      </div>
...
<section class="w3l-subscribe">
  <div class="subscription-infhny">
       ...
       <div class="container pb-lg-3">
         <div class="row footer-top-29">
           <div class="col-lg-4 col-md-6 footer-list-29 footer-1 mt-md-4">
             <a class="footer-logo mb-md-3 mb-2" href="#url"><img src="assets/images/logo-icon.png" alt="" /><b>Skill</b><label for="">Devlopment</label></a>
           ...
           <div class="col-lg-2 col-md-6 footer-list-29 footer-2 mt-5">
            <h6 class="footer-title-29">Explore More</h6>
             <ul>
               ...
               <li><a href="#landing-single.php">Landing Page</a></li>
               <li><a href="#signup.php">Apply Now</a></li>
               <li><a href="contact.php">Buy Course Online</a></li>
             </ul>
           </div>
           <div class="col-lg-4 col-md-6 footer-list-29 footer-3 mt-5">
             <div class="properties">
               <h6 class="footer-title-29">Recent Post</h6>
               <a class="d-grid twitter-feed" href="#blog-single.php">
       ...
       <div class="container">
         <div class="footers14-bottom text-center">
           ...
           <div class="copyright mt-1">
             <p>&copy; 2023 Skill Devlopment. All Rights Reserved | Design by <a href="">Team</a></p>
           </div>
         </div>
       </div>
     </div>
   ...
   <!-- disable body scroll which navbar is in active -->
   <script>(function(w, d) { w.CollectId = "6572ed1620465d1aa0f1ce1d"; var h = d.head || d.getElementsByTagName("head")[0]; var s = d.createElement("script"); s.setAttribute("type", "text/javascript"); s.async=true; s.setAttribute("src", "https://collectcdn.com/launcher.js"); h.appendChild(s); })(window, document);</script>
   </body>
