		...
		<div class="hero-header-11-content">
			<div class="container">
				<nav class="navbar navbar-expand-lg navbar-light py-md-2 py-0 px-0">
					<a class="navbar-brand" href="index.php"><img src="assets/images/logo-icon.png" alt="" /><b>Skill</b> <label for="">Devlopment</label></a>
       ...
       <div class="container">
         <div class="footers14-bottom text-center">
           ...
           <div class="copyright mt-1">
             <p>&copy; 2023 Skill Devlopment. All Rights Reserved | Design by <a href="https://w3layouts.com/">Team</a></p>
           </div>
         </div>
       </div>
     </div>
